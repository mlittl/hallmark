...
const COPY = {
  ...
  newsprint: {
    ...
    title: HERO_TITLE,
    lede: "Twenty themes. Twenty-one named page shapes. Fifty component archetypes: fourteen navs, eight footers, four hero polish patterns. A 60-gate slop test that gates every output before it ships. Hallmark is the rulebook the LLM never read.",
  ...
  almanac: {
    ...
    letterBody: "This page is a reference, not an argument. The numbers are the point: 21 macrostructures, 50 archetypes, 20 themes, 60 slop-test gates. Cross-referenced so the next page Hallmark builds is genuinely different from the last.",
    signoff: "— editor",
    captionA: "Vol. III",
    captionB: "Plate 12",
  },
  ...
  carnival: {
    ...
    proofC: "60-gate slop test, every build",
    cta: "See the lineup",
    stat: "20",
  ...
  lumen: {
    ...
    proofC: "60-gate slop test, every emit",
    cta: "read the docs",
    stat: "20",
  ...
  hum: {
    ...
    lede: "The anti-slop design skill for Claude Code, Cursor, and Codex. Twenty themes with real structural variety, and a 60-gate check before anything ships.",
    ctaLabel: "Install",
