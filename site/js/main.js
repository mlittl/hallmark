...
const ARCHETYPES = {
  ...
  pastel:    { hero: "letter",       footer: "masthead" },
...
const COPY = {
  ...
  pastel: {
    eyebrow:    "v0.2 · post-Linear soft",
    title:      "Soft, but exact.",
    lede:       "A skill that prefers soft surfaces and exact rules. Buttery paper. Slate ink. One indigo accent at low chroma — never a gradient.",
    ctaLabel:   "Open it",
    ...
    letterBody:"This page is soft because the surface should be soft. The rules underneath are not — there are twenty-nine of them, and the page passed every one. We hope it feels like the modern dev tools you already love, just with fewer gradients.",
    signoff:    "Take care,",
