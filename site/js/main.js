...
const COPY = {
  ...
  newsprint: {
    ...
    title: HERO_TITLE,
    lede: "Twenty themes. Twenty-one named page shapes. Fifty component archetypes — fourteen navs, eight footers, four hero polish patterns. A 70-gate slop test that gates every output before it ships. Hallmark is the rulebook the LLM never read.",
  ...
  almanac: {
    ...
    letterBody: "This page is a reference, not an argument. The numbers are the point: 21 macrostructures, 50 archetypes, 20 themes, 70 slop-test gates. Cross-referenced so the next page Hallmark builds is genuinely different from the last.",
    signoff: "— editor",
    captionA: "Vol. III",
    captionB: "Plate 12",
  },
  ...
  carnival: {
    ...
    proofC: "70-gate slop test, every build",
    cta: "See the lineup",
    stat: "20",
  ...
  lumen: {
    ...
    proofC: "70-gate slop test, every emit",
    cta: "read the docs",
    stat: "20",
